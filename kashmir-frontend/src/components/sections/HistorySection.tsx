    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            fontSize: '1.1rem', cursor: 'pointer', lineHeight: 1, padding: '0 0 0 1rem',
          }}
        >×</button>
      </div>
      <div style={{ padding: '1rem 1.25rem 1.25rem' }}>
        <div style={{
          ...
          color: 'var(--color-snow)', lineHeight: 1.3, marginBottom: '0.3rem',
        }}>
          {doc.name}
        </div>
        <div style={{
          fontFamily: 'var(--font-mono)', fontSize: '0.62rem', letterSpacing: '0.07em',
          color: 'var(--color-ash-text)', marginBottom: '0.875rem',
        }}>
          {doc.date} · {doc.source}
        </div>
        <p style={{
          fontFamily: 'var(--font-body)', fontSize: '0.875rem',
          color: 'var(--color-snow-dim)', lineHeight: 1.72, margin: '0 0 1rem',
        }}>
          {doc.desc}
        </p>
        <a
...
/* ─── Single event card ─────────────────────────────────────────────────── */
function EventCard({ event, accent, isLast }: { event: TimelineEvent; accent: string; isLast: boolean }) {
  ...
  return (
    <div
      ref={ref}
      style={{
        display: 'grid', gridTemplateColumns: '68px 1fr', gap: '0 1.25rem',
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{
          ...
          textAlign: 'center', marginBottom: '0.5rem', paddingTop: '0.85rem', lineHeight: 1,
        }}>
          {event.year}
        </div>
        {!isLast && (
          <div style={{
            width: '1px', flexGrow: 1, minHeight: '20px',
      ...
      >
        <div style={{
          ...
          alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.35rem',
        }}>
          <h3 style={{
            fontFamily: 'var(--font-display)',
            fontSize: 'clamp(0.95rem, 1.6vw, 1.05rem)',
            color: 'var(--color-snow)', fontWeight: 500, lineHeight: 1.25, margin: 0,
          }}>
            {event.title}
          </h3>
          <span style={{
            ...
            color: cat.color, border: `1px solid ${cat.color}38`,
        ...
        {event.place && (
          <div style={{
            ...
            letterSpacing: '0.1em', color: 'rgba(255,255,255,0.3)', marginBottom: '0.65rem',
          }}>
            ◦ {event.place}
          </div>
        )}
        ...
        <p style={{
          ...
          color: 'var(--color-snow-dim)', lineHeight: 1.72,
...
function EraHeader({ era, count }: { era: typeof ERAS[number]; count: number }) {
  ...
  return (
    <div ref={ref} style={{ marginBottom: '2rem', transition: 'opacity 0.6s ease, transform 0.6s ease' }}>
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: 'var(--font-mono)', fontSize: '0.6rem',
          letterSpacing: '0.2em', textTransform: 'uppercase',
          color: era.accent, marginBottom: '0.4rem', opacity: 0.85,
        }}>
        ...
        <h2 style={{
          ...
          color: 'var(--color-snow)', fontWeight: 400,
      ...
      <div className="section-container">
        ...
        <div style={{ maxWidth: '700px', marginBottom: 'clamp(2.5rem, 5vw, 4rem)' }}>
          ...
          <h2 style={{
            ...
            lineHeight: 1.05, marginBottom: '1.1rem',
          }}>
            700 years.<br />One valley.<br />
            <span style={{ color: 'rgba(255,255,255,0.32)' }}>No easy answer.</span>
          </h2>
          <p style={{
            fontFamily: 'var(--font-body)',
            fontSize: 'clamp(0.95rem, 1.5vw, 1.05rem)',
            color: 'var(--color-snow-dim)', lineHeight: 1.72, margin: '0 0 1.5rem',
          }}>
            An independent historical archive spanning the Shah Mir sultanate to Operation Sindoor.
            {docCount > 0 && <> {docCount} events link to primary sources — treaties, UN resolutions, constitutional orders, and court judgments you can read in full.</>}
          </p>
            ...
            {[
              ...
              <div key={s.label} style={{
                ...
                <span style={{
                  ...
                  fontWeight: 700, color: 'var(--color-saffron)',
                }}>{s.n}</span>
                <span style={{
                  fontFamily: 'var(--font-mono)', fontSize: '0.58rem',
                  letterSpacing: '0.12em', textTransform: 'uppercase',
        ...
        <div style={{
          ...
          marginBottom: '3rem', padding: '0.875rem 1rem',
          ...
          <div style={{ position: 'relative', flex: '1 1 220px', minWidth: '180px' }}>
            ...
            <input
              ...
              style={{
                width: '100%', padding: '0.5rem 0.875rem 0.5rem 1.875rem',
                background: 'rgba(255,255,255,0.05)',
                border: '1px solid rgba(255,255,255,0.09)',
                borderRadius: '6px', fontFamily: 'var(--font-body)',
                fontSize: '0.875rem', color: 'var(--color-snow)',
          ...
          <div style={{ display: 'flex', gap: '0.3rem', flexWrap: 'wrap' }}>
            {(['all', 'political', 'conflict', 'cultural', 'humanitarian'] as Filter[]).map(f => {
              ...
              const cnt = f === 'all' ? filtered.length : filtered.filter(e => e.category === f).length;
              return (
                <button key={f} onClick={() => setFilter(f)} style={{
                  fontFamily: 'var(--font-mono)', fontSize: '0.6rem',
                  letterSpacing: '0.13em', textTransform: 'uppercase',
                  padding: '0.38rem 0.7rem', borderRadius: '4px',
        ...
        <div style={{
          ...
          <div style={{ position: 'sticky', top: '5rem' }}>
            <div style={{
              ...
              letterSpacing: '0.2em', textTransform: 'uppercase',
              color: 'rgba(255,255,255,0.25)', marginBottom: '0.75rem', paddingLeft: '0.75rem',
            }}>Eras</div>
            ...
            <nav aria-label="Jump to historical era">
              {ERAS.map(era => {
                ...
                return (
                  <button key={era.id} onClick={() => scrollToEra(era.id)}
                    style={{
                      display: 'block', width: '100%', textAlign: 'left',
                      border: 'none', background: on ? `${era.accent}10` : 'none',
                      padding: '0.5rem 0.75rem',
                      borderLeft: `2px solid ${on ? era.accent : 'rgba(255,255,255,0.07)'}`,
                      borderRadius: '0 5px 5px 0', marginBottom: '2px',
                      cursor: 'pointer', transition: 'all 0.2s',
                    }}
                  >
                    <div style={{
                      fontFamily: 'var(--font-mono)', fontSize: '0.58rem', letterSpacing: '0.08em',
                      color: on ? era.accent : 'rgba(255,255,255,0.25)', marginBottom: '1px',
                    }}>{era.range}</div>
                    <div style={{
                      fontFamily: 'var(--font-body)', fontSize: '0.77rem',
                      color: on ? 'var(--color-snow)' : 'rgba(255,255,255,0.45)',
                      lineHeight: 1.3, fontWeight: on ? 600 : 400,
                    }}>{era.name}</div>
                    {cnt > 0 && (
                      <div style={{
                        fontFamily: 'var(--font-mono)', fontSize: '0.54rem',
                        color: on ? `${era.accent}80` : 'rgba(255,255,255,0.18)', marginTop: '1px',
                      }}>{cnt} event{cnt !== 1 ? 's' : ''}</div>
                    )}
                  </button>
                );
              })}
            ...
            <div style={{ marginTop: '1.75rem', paddingTop: '1.25rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
              <div style={{
                fontFamily: 'var(--font-mono)', fontSize: '0.56rem',
                letterSpacing: '0.2em', textTransform: 'uppercase',
                color: 'rgba(255,255,255,0.25)', marginBottom: '0.6rem',
              }}>Legend</div>
              {Object.entries(CAT).map(([key, { color, label }]) => (
                <div key={key} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.3rem' }}>
                  <div style={{ width: '12px', height: '2px', borderRadius: '1px', background: color, flexShrink: 0 }} />
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6rem', color: 'rgba(255,255,255,0.3)' }}>{label}</span>
                </div>
              ))}
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.4rem' }}>
                <span style={{ fontSize: '0.6rem' }}>📄</span>
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6rem', color: 'rgba(255,255,255,0.3)' }}>Primary source</span>
              </div>
            </div>
          </div>
          ...
          <div>
                ...
                >
                  ...
                  {eraEvents.length > 0 ? (
                    ...
                    <p style={{
                      ...
                      letterSpacing: '0.06em', color: 'rgba(255,255,255,0.18)', padding: '0.75rem 0',
                    }}>
            ...
            {filtered.length === 0 && (
              <div style={{ textAlign: 'center', padding: '4rem 0 3rem' }}>
                ...
                <button
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = 'rgba(255,255,255,0.7)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(255,255,255,0.3)'; }}
            ...
            {filtered.length > 0 && (
              <div style={{ marginTop: '1rem', paddingTop: '2.5rem', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                <p style={{
                  fontFamily: 'var(--font-display)', fontStyle: 'italic',
                  fontSize: 'clamp(0.9rem, 1.4vw, 1.05rem)',
                  color: 'rgba(255,255,255,0.2)', lineHeight: 1.7, margin: 0,
                }}>
